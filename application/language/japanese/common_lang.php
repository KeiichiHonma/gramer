...
$lang['common_header_title'] = '価格固定主義カンパニー 思いついたアイディアをインターネット上に | ウェブサービス開発のグラマー[Gramer]';
$lang['common_header_keywords'] = 'ウェブサービス,東京,北海道,札幌,開発,受託開発,グラマー,Gramer';
$lang['common_header_description'] = 'Gramerは、価格“固定“を目指す、東京と北海道を拠点とするウェブサービス開発を得意としたプログラマー集団の会社です。私たちの開発チームは、美しくて使い勝手の良いグラマーなウェブサービスを提供します。';
