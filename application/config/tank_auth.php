...
|--------------------------------------------------------------------------
*/
$config['website_name'] = 'The-o';
$config['info_email'] = 'keiichi-honma@813.co.jp';
$config['webmaster_email'] = ENVIRONMENT == 'development' ? 'honma@zeus.corp.813.co.jp' : 'keiichi-honma@813.co.jp';
...
$config['first_name_min_length'] = 2;
$config['first_name_max_length'] = 50;
$config['middle_name_min_length'] = 2;
$config['middle_name_max_length'] = 50;
$config['last_name_min_length'] = 2;
$config['last_name_max_length'] = 50;


$config['password_min_length'] = 4;
$config['password_max_length'] = 20;

$config['address_min_length'] = 2;
$config['address_max_length'] = 255;
$config['zip_min_length'] = 1;
$config['zip_max_length'] = 100;
$config['phone_min_length'] = 1;
$config['phone_max_length'] = 100;

$config['website_max_length'] = 255;
$config['biography_max_length'] = 1000;
$config['self_pr_max_length'] = 1000;

$config['default_birthday_year'] = 1980;
